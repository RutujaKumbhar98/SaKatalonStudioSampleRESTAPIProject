...
response1 = WS.sendRequest(findTestObject('RESTWrbServices/ListUsers'))
...
//WS.sendRequestAndVerify(findTestObject('RESTWrbServices/updateUser'))

WS.sendRequest(findTestObject('RESTWrbServices/updateUser', [('userName') : value]))
